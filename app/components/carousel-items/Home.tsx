        ...
        <div id="home" className="carousel-item h-full bg-secondary-content">
            <div className='container mx-auto mb-16 px-4 flex flex-col justify-center items-center gap-8'>
                ...
                <div className="flex flex-col gap-4">
                    <a href='https://instagram.com/narenj.web' className='btn btn-outline btn-secondary'>
                        <FaInstagram className="text-2xl" />
                        اینستاگرام
                    </a>
                    <a href='https://t.me/narenj_web' className='btn btn-outline btn-secondary'>
                        <FaTelegramPlane className="text-2xl" />
                        تلگرام
                    </a>
                    <a href='tel:+981144422984' className='btn btn-outline btn-secondary'>
                        <FaPhoneFlip className="text-xl" />
                        تماس
                    </a>
                    <a href='mailto:narenj.official@gmail.com' className='btn btn-outline btn-secondary'>
